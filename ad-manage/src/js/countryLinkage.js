    ...
    [
        ...
        },
        {
            ...
            sub: [
                ...
                {
                    name: "香港",
                    sub: [{ name: "地级市、县" }, { name: "香港岛" }, { name: "九龙" }, { name: "新界" }],
                    type: 0
                },
                {
                    name: "澳门",
                    sub: [{ name: "地级市、县" }, { name: "澳门半岛" }, { name: "离岛" }],
                    type: 0
                },
                {
                    name: "台湾",
                    sub: [{ name: "地级市、县" }, { name: "台北" }, { name: "新北" }, { name: "桃园" }, { name: "台中" }, { name: "台南" }, { name: "高雄" }, { name: "基隆" }, { name: "新竹" }, { name: "嘉义" }],
                    type: 0
                },
