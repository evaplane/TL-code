    ...
    <div class="content" style='padding:0;margin-right:10px;'>
        ...
        <el-form :model="form" :rules="addDeptRules" ref="form" label-width="100px" style="padding:30px" class="demo-ruleForm">
          ...
          <el-row>
            ...
            <el-col :span="2"><div class="grid-content">
                <el-button plain @click="backToNoticeDept">取消</el-button>
            </div></el-col>
          </el-row>
    </div>
  </div>
        ...
        deptAddSubmit(formName){
          this.$refs[formName].validate((valid) => {
            if (valid) {
              ...
              this.$post("common-web/notice/updateNotice",data).then(res=>{
                console.log(res);
                if(res.code=='000000'){
                  this.$message({
                    message: '修改成功',
