...
(function($) {
    ...
    var isIE = function(ver) {
        ...
        previewCache = {
            ...
            out: function(id) {
                var html = '',
                    data = previewCache.data[id],
                    caption, len = previewCache.count(id);
                if (len === 0) {
        ...
        // tPreview = '<div class="file-preview {class}">\n' +
         tPreview = '    <div class="close fileinput-remove">&times;</div>\n' +
        '    <div class="{dropClass}">\n' +
    ...
    FileInput.prototype = {
        ...
        initUploadSuccess: function(out, $thumb, allFiles) {
            var self = this,
                append, data, index, $newThumb, content, config, tags;
