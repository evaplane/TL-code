(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
	...
	proto.Model.toObject = function(includeInstance, msg) {
	  var f, obj = {
		...
		trackid: jspb.Message.getFieldWithDefault(msg, 17, ""),
		type: jspb.Message.getFieldWithDefault(msg, 18, 0),
		clientplatform: jspb.Message.getFieldWithDefault(msg, 19, ""),
		clientbrowser: jspb.Message.getFieldWithDefault(msg, 20, ""),
		clientip: jspb.Message.getFieldWithDefault(msg, 21, ""),
		islineup: jspb.Message.getFieldWithDefault(msg, 22, 0),
		country: jspb.Message.getFieldWithDefault(msg, 23, ""),
		province: jspb.Message.getFieldWithDefault(msg, 24, ""),
		city: jspb.Message.getFieldWithDefault(msg, 25, ""),
		userid: jspb.Message.getFieldWithDefault(msg, 26, ""),
		customertaginfo: jspb.Message.getFieldWithDefault(msg, 27, "")
	  };
	 ...
	 * @return {string}
	 */
	proto.Model.prototype.getRole = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 16, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setRole = function(value) {
	  jspb.Message.setProto3StringField(this, 16, value);
	};


	/**
	 * optional string trackId = 17;
	 * @return {string}
	 */
	proto.Model.prototype.getTrackid = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 17, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setTrackid = function(value) {
	...
	/**
	 * optional string clientPlatform = 19;
	 * @return {string}
	 */
	proto.Model.prototype.getClientplatform = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 19, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setClientplatform = function(value) {
	  jspb.Message.setProto3StringField(this, 19, value);
	};


	/**
	 * optional string clientBrowser = 20;
	 * @return {string}
	 */
	proto.Model.prototype.getClientbrowser = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 20, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setClientbrowser = function(value) {
	  jspb.Message.setProto3StringField(this, 20, value);
	};


	/**
	 * optional string clientIp = 21;
	 * @return {string}
	 */
	proto.Model.prototype.getClientip = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 21, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setClientip = function(value) {
	  jspb.Message.setProto3StringField(this, 21, value);
	};


	/**
	 * optional uint32 isLineUp = 22;
	 * @return {number}
	 */
	proto.Model.prototype.getIslineup = function() {
	  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 22, 0));
	};


	/** @param {number} value */
	proto.Model.prototype.setIslineup = function(value) {
	 ...
	 * @return {string}
	 */
	proto.Model.prototype.getCountry = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 23, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setCountry = function(value) {
	  jspb.Message.setProto3StringField(this, 23, value);
	};


	/**
	 * optional string province = 24;
	 * @return {string}
	 */
	proto.Model.prototype.getProvince = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 24, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setProvince = function(value) {
	 ...
	 * @return {string}
	 */
	proto.Model.prototype.getCity = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 25, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setCity = function(value) {
	  jspb.Message.setProto3StringField(this, 25, value);
	};


	/**
	 * optional string userId = 26;
	 * @return {string}
	 */
	proto.Model.prototype.getUserid = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 26, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setUserid = function(value) {
	  jspb.Message.setProto3StringField(this, 26, value);
	};


	/**
	 * optional string customerTagInfo = 27;
	 * @return {string}
	 */
	proto.Model.prototype.getCustomertaginfo = function() {
	  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 27, ""));
	};


	/** @param {string} value */
	proto.Model.prototype.setCustomertaginfo = function(value) {
