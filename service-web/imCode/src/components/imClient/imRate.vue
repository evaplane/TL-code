 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2019-09-02 21:51:41
 -->
    <!-- 评价 -->
    <template>
    <div class="imRate-wrapper">
        <div v-show="!resultVisible" class="main">
        <p class="title">感谢你的咨询，请对我们的服务进行评价</p>
        <el-row>
            <el-rate v-model="dataForm.score" show-text :texts="['非常不满意', '不满意', '一般', '满意', '非常满意']"></el-rate>
        </el-row>
        <el-row>
            <el-input
            type="textarea"
            ...
            :rows="4"
            resize="none"
            placeholder="备注(选填，50字符以内)"
            v-model="dataForm.remark"
            ></el-input>
        </el-row>
        <el-button
            type="primary"
            class="submit-btn position-h-mid"
            @click="submit"
            :disabled="dataForm.score==null"
        >确定</el-button>
        </div>
        <!-- 评价后的界面 -->
