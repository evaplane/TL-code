<template>
  <div>
    <main class="main">
        <div class="item-list">
            <div class="item" v-for="(tmpEn, index) in storeServedData" :key="index" @click="selectChat(tmpEn)" v-bind:class="{ active: selectedChatEn!=null && tmpEn.clientChatId==selectedChatEn.clientChatId}">
...
<script>
export default {
  props:['storeCurrentChatEnlist'],
    data() {
        return {
          storeServedData:this.storeCurrentChatEnlist,
          activeNames:[],
        };
    },
    computed: {
