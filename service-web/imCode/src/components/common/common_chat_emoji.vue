 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2019-10-28 15:07:42
 -->
<!-- qq表情 -->
<template>
    <div class="common_chat_emoji-wrapper common_chat_emoji-wrapper-global" @click="faceHidden=true">
        <a href="javascript:void(0)" @click.stop="toggleFaceHidden">
            <i class="iconfont-main icon-biaoqing"></i>
        </a>
