 ...
 * 小于
 */
export function lt(num1: stringOrNumber, num2: stringOrNumber): boolean {
  var baseNum = Math.pow(10, Math.max(digitLength(num1), digitLength(num2)));
  return Number(multiply(num1, baseNum)) < Number(multiply(num2, baseNum));
}

/**
 * 小于等于
 */
export function lte(num1: stringOrNumber, num2: stringOrNumber): boolean {
  var baseNum = Math.pow(10, Math.max(digitLength(num1), digitLength(num2)));
  return Number(multiply(num1, baseNum)) <= Number(multiply(num2, baseNum));
}
 ...
 * 小于
 */
export function gt(num1: stringOrNumber, num2: stringOrNumber): boolean {
  var baseNum = Math.pow(10, Math.max(digitLength(num1), digitLength(num2)));
  return Number(multiply(num1, baseNum)) > Number(multiply(num2, baseNum));
}
 ...
 * 小于等于
 */
export function gte(num1: stringOrNumber, num2: stringOrNumber): boolean {
  var baseNum = Math.pow(10, Math.max(digitLength(num1), digitLength(num2)));
  return Number(multiply(num1, baseNum)) >= Number(multiply(num2, baseNum));
}

export function min(num1: stringOrNumber, num2: stringOrNumber): stringOrNumber {
  return lte(num1, num2) ? num1 : num2;
}

export function max(num1: stringOrNumber, num2: stringOrNumber): stringOrNumber {
  return gte(num1, num2) ? num1 : num2;
}
